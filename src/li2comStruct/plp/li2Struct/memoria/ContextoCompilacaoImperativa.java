 ...
 */
public class ContextoCompilacaoImperativa implements AmbienteCompilacaoImperativa2 {
    ...
    public ContextoCompilacaoImperativa(ListaValor entrada){
        ...
        mapDefClasse = new HashMap<Id, DefStruct>();  //cria mapeamento ids def classes
    ...
    public void map(Id idArg, Tipo tipoId)
        ...
        HashMap<li2comStruct.plp.expressions2.expression.Id, Tipo> aux = pilha.peek();
