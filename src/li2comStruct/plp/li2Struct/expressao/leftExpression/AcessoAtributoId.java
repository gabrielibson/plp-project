...
import li2comStruct.plp.li2Struct.memoria.ContextoObjeto;
import li2comStruct.plp.li2Struct.memoria.DefStruct;
...
public class AcessoAtributoId extends AcessoAtributo{
    ...
    public boolean checaTipo(AmbienteCompilacaoImperativa2 ambiente)
        ...
        if(av.checaTipo(ambiente)) {
            try{
                ...
                DefStruct defClasse = ambiente.getDefClasse(((TipoStruct)t).getTipo());
    ...
    public Tipo getTipo(AmbienteCompilacaoImperativa2 ambiente)
        ...
        Id nomeClasse = ((TipoStruct)av.getTipo(ambiente)).getTipo();
        DefStruct defClasse = ambiente.getDefClasse(nomeClasse);
    ...
    private Valor obterValorDeIdNoAmbiente(AmbienteExecucaoImperativa2 ambiente)
        ...
        InstanciaStruct objeto = ambiente.getObjeto(referencia);
