...
/*  ADICIONADO OU MODIFICADO DA Imperativa1 PARA A Imperativa2  */
  ...
  static final public DeclaracaoStruct PDeclaracaoStruct() throws ParseException {
    trace_call("PDeclaracaoStruct");
    try {
        Id nome;
        DefStruct defStruct;
      if (jj_2_17(2147483647)) {
        ...
        default:
          ...
          throw new ParseException();
            ...
            {if (true) return new DeclaracaoStruct (nome, defStruct);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PDeclaracaoStruct");
    }
  }

  static final public DefStruct PDefStruct() throws ParseException {
    trace_call("PDefStruct");
    try {
        ListaDeclaracaoVariavel listaVar = null;
      listaVar = PListaDeclaracaoVariavel();
      jj_consume_token(RBRACE);
            if(listaVar == null) {
                listaVar = new ListaDeclaracaoVariavel();
            }
            {if (true) return new DefStruct(listaVar);}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PDefStruct");
    }
  }
  ...
  static final public ListaDeclaracaoVariavel PListaDeclaracaoVariavel() throws ParseException {
    trace_call("PListaDeclaracaoVariavel");
    try {
        DeclaracaoVariavel decVar;
        ListaDeclaracaoVariavel lista = null;
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case VAR:
        decVar = PDeclaracaoVariavel();
                                                 lista = new ListaDeclaracaoVariavel(decVar);
        break;
      default:
        jj_la1[15] = jj_gen;
        ;
      ...
      while (true) {
        ...
        jj_consume_token(SEMICOLON);
        decVar = PDeclaracaoVariavel();
                                                 lista = new ListaDeclaracaoVariavel(decVar, lista);
      }
                if (lista == null) {
                        lista = new ListaDeclaracaoVariavel();
                }
                {if (true) return lista;}
    throw new Error("Missing return statement in function");
    } finally {
      trace_return("PListaDeclaracaoVariavel");
    }
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x23b0000,0x180000,0x6000,0x40006000,0x40006000,0x1800,0x40006000,0x23b0000,0x5008000,0x1000000,0x38000000,0x4000000,0x38000000,0x38000000,0x0,0x8000,0x0,0x40007800,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x148,0x0,0x0,0x4,0x4c,0x80000000,0x4c,0x148,0x40,0x0,0x2180,0x0,0x0,0x0,0x2000,0x0,0x1000,0x8000004c,0x2000,};
   }
